package com.teamnet.app.devicemanager.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("devicemanager");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("devicemanager");
        ...
        config.getMapConfigs().put("com.teamnet.app.devicemanager.domain.*", initializeDomainMapConfig(jHipsterProperties));
