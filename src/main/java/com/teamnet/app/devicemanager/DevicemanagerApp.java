package com.teamnet.app.devicemanager;

import com.teamnet.app.devicemanager.config.ApplicationProperties;
import com.teamnet.app.devicemanager.config.DefaultProfileUtil;
...
public class DevicemanagerApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(DevicemanagerApp.class);
